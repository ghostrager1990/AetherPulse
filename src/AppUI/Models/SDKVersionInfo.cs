    ...
    public static class SDKVersionDiscovery
    {
        public static SDKComponentVersion GetFidelityFXVersion()
        {
            return new SDKComponentVersion
            {
                ...
                VersionString = "v3.1.2 (FFX SDK 2026.1)",
        ...
        public static SDKComponentVersion GetStreamlineInteropVersion()
        {
            return new SDKComponentVersion
            {
                ComponentName = "NVIDIA Streamline Interposer",
                VersionString = "SL DLSS-D v2.4.0 Interop",
                Status = "Proxy Injected",
                Details = "slSetTag & slEvaluateFeature interception and buffer routing"
            };
        }
    }
}
